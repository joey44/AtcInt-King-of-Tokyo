...
import AtcIntClient.EventHandlerClient;
...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		button1.setFont(Font.font("Arial", FontWeight.BLACK,
		...
		ImageView image = new ImageView(new Image(getClass()
				.getResourceAsStream("/Images/KingOfTokyo1.jpg"), 600, 600,
				true, true));
		...
		ImageView image2 = new ImageView(new Image(getClass()
				.getResourceAsStream("/Images/Wuerfel_1_hellgruen.jpg"), 50,
				50, true, true));
		fp.getChildren().add(image2);
		ImageView image3 = new ImageView(new Image(getClass()
				.getResourceAsStream("/Images/Wuerfel_1_schwarz.jpg"), 50, 50,
				true, true));
